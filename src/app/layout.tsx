...
export const metadata: Metadata = {
  title: "Techshop - Ristorante Italiano Autentico a Milano",
  description: "Scoprite Techshop, ristorante italiano autentico nel cuore di Milano. Cucina tradizionale con ingredienti freschi, menu degustazione e atmosfera genuina dal 1952.",
  keywords: ["ristorante italiano Milano", "cucina tradizionale", "pasta carbonara", "pizza napoletana", "menu degustazione Milano", "ristorante autentico"],
  metadataBase: new URL("https://techshop-milano.it"),
  alternates: {
    canonical: "https://techshop-milano.it"
  },
  openGraph: {
    title: "Techshop - Ristorante Italiano Autentico a Milano",
    description: "Cucina tradizionale italiana nel cuore di Milano con ingredienti freschi e ricette autentiche dal 1952",
    url: "https://techshop-milano.it",
    siteName: "Techshop Ristorante Milano",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763590823875-qglg7k7p.jpg",
      alt: "Interno del ristorante Techshop a Milano"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Techshop - Ristorante Italiano Autentico a Milano",
    description: "Cucina tradizionale italiana nel cuore di Milano con ingredienti freschi e ricette autentiche",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763590823875-qglg7k7p.jpg"]
  },
  robots: {
    index: true,
    follow: true
